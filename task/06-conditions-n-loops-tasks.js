...
function timespanToHumanString(startDate, endDate) {
    ...
    if (ms > 2160000000 && ms <= 3888000000) {
        return 'a month ago';
    }
    ...
    if (ms > 29808000000 && ms <= 47088000000) {
        return 'a year ago';
    }
    if (ms > 47088000000) {
